...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Insulfilme, envelopamento, som e LEDs. Agende online e pague no local.",
      },
      { name: "author", content: "Full Sound Garage" },
      ...
      { name: "twitter:title", content: "Full Sound Garage — Agendamento online" },
      {
